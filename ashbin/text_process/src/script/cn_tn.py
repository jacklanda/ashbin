...
COM_QUANTIFIERS = '(匹|张|座|回|场|尾|条|个|首|阙|阵|网|炮|顶|丘|棵|台|只|支|袭|辆|挑|担|颗|壳|窠|曲|墙|群|腔|' \
                  '砣|座|客|贯|扎|捆|刀|令|打|手|罗|坡|山|岭|江|溪|钟|队|单|双|对|出|口|头|脚|板|跳|枝|件|贴|' \
                  '针|线|管|名|位|身|堂|课|本|页|家|户|层|丝|毫|厘|分|钱|两|斤|担|铢|石|钧|锱|忽|(千|毫|微)克|' \
                  '毫|厘|分|寸|尺|丈|里|寻|常|铺|程|(千|分|厘|毫|微)米|撮|勺|合|升|斗|石|盘|碗|碟|叠|桶|笼|盆|' \
                  '盒|杯|钟|斛|锅|簋|篮|盘|桶|罐|瓶|壶|卮|盏|箩|箱|煲|啖|袋|钵|年|月|日|季|刻|时|周|天|秒|分|旬|' \
                  '纪|岁|世|更|夜|春|夏|秋|冬|代|伏|辈|丸|泡|粒|颗|幢|堆|条|根|支|道|面|片|张|颗|块|度|摄氏度)'
...
def nsw_test_case(raw_text):
    ...
    print(NSWNormalizer(raw_text).normalize())
...
def nsw_test():
    ...
    nsw_test_case('0595-23865596或23880880。')
    nsw_test_case('0595-23865596或23880880。')
    nsw_test_case('+86 19859213959或15659451527。')
    nsw_test_case('32477/76391。')
    nsw_test_case('80.03%。')
    nsw_test_case('31520181154418。')
    nsw_test_case('2983.07克或12345.60米。')
    nsw_test_case('1999年2月20日或09年3月15号。')
    nsw_test_case('12块5，34.5元，20.1万')
    nsw_test_case('O2O或B2C。')
    nsw_test_case('3456万吨')
    nsw_test_case('2938个')
    nsw_test_case('938')
    nsw_test_case('今天吃了115个小笼包231个馒头')
...
if __name__ == '__main__':
    ...
    for l in ifile:
        ...
        # old_chars = CHINESE_PUNC_NON_STOP + string.punctuation # includes all CN and EN punctuations except chinese punc stop
